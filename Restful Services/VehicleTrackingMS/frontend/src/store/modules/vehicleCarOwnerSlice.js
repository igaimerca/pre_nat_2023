...
export const AuthSlice = createSlice({
  ...
  reducers: {
    ...
    addVehicleCarOwner: (state, action) => {
      state.vehicleCarOwnerCarOwners.docs = [
        ...state.vehicleCarOwnerCarOwners.docs,
        action.payload,
      ];
    },
    ...
    removeVehicleCarOwner: (state, action) => {
      state.vehicleCarOwnerCarOwners.docs =
        state.vehicleCarOwnerCarOwners.docs.filter(
          (vehicleCarOwner) => vehicleCarOwner._id !== action.payload
        );
    },
  },
});
...
export const selectVehicleCarOwners = (state) =>
  state.vehicleCarOwner.vehicleCarOwnerCarOwners.docs;
export const isVehicleCarOwnersLoaded = (state) =>
  states.vehicleCarOwner.isVehicleCarOwnersLoaded;
